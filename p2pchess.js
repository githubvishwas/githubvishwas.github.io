...
var sendmove = function() {
	...
	var gameUrl = "http://githubvishwas.github.io/justplaychess.html?fen="+orgStartPos+"&source="+glb_source+"&target="+glb_target+"&p2pmode="+otherp2pmode+"&peerid=" +peerid +"&connected="+connected;
	//for debug
